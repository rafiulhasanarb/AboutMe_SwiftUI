...
struct GraphSeismometer: View {
    @EnvironmentObject private var detector: SeismometerMotionDetector
...
struct GraphSeismometer_Previews: PreviewProvider {
    @StateObject static private var detector = SeismometerMotionDetector(updateInterval: 0.01).started()
